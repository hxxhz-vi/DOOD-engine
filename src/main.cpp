...
std::vector<uint32_t> framebuf (SCREEN_WIDTH* SCREEN_HEIGHT, 255);
...
void
draw_triangel (std::vector<uint32_t>& img, const size_t x, const size_t y,
              ...
              for (int mx = 0; mx < map_w; ++mx)
                {
                  ...
                  draw_triangel (framebuf, rect_x, rect_y, rect_w, rect_h,
